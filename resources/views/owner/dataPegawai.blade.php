...
<form action="/dataPegawai/search" method="get">
    <div class="form-group row">
        <div class="col-sm-4 mt-4">
            <input type="text" class="form-control" id="cari" placeholder="Cari nama" name="cari">
        </div>
...
<div height="200px">
    <table id="myTable" class="table table-striped table-bordered mt-3 overflow-auto h-25">
        <thead>
            <tr>
                <th>Id Pegawai</th>
                <th>Nama</th>
